...
from tf_nlp.utils import GO_ID, PAD_ID
from tf_seq2seq_lib import *
...
class Seq2SeqModel(object):
    ...
    def __init__(self, source_vocab_size, target_vocab_size, buckets, size,
                 ...
                 num_samples=1024, forward_only=False, beam_search=True,
                 beam_size=10, attention=True):
        """Create the model.
        Args:
        ...
        if forward_only:
            if beam_search:
                self.outputs, self.beam_path, self.beam_symbol = \
                    decode_model_with_buckets(self.encoder_inputs,
