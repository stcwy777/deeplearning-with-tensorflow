"""This module is modified from tensorflow source code.
See https://github.com/tensorflow/tensorflow/blob/master/tensorflow/python/ops/seq2seq.py
for raw file.
Original modification is made by https://github.com/pbhatia243.
"""
...
def beam_rnn_decoder(decoder_inputs, initial_state, cell, loop_function=None,
    ...
    return outputs, state, tf.reshape(tf.concat(0, beam_path),
        ...
        tf.concat(0, beam_symbols), [-1, beam_size])
...
def embedding_rnn_seq2seq(encoder_inputs, decoder_inputs, cell,
    ...
    with variable_scope.variable_scope(scope or "embedding_rnn_seq2seq"):
        ...
        return embedding_rnn_decoder(
            ...
            feed_previous=feed_previous, beam_search=beam_search,
            beam_size=beam_size)
...
def beam_attention_decoder(decoder_inputs, initial_state, attention_states,
                           cell,
                           output_size=None, num_heads=1, loop_function=None,
                           dtype=dtypes.float32, scope=None,
                           initial_state_attention=False,
                           output_projection=None, beam_size=10):
    """RNN decoder with attention for the sequence-to-sequence model.
    In this context "attention" means that, during decoding, the RNN can look up
    information in the additional tensor attention_states, and it does this by
    focusing on a few entries from the tensor. This model has proven to yield
...
def embedding_attention_decoder(decoder_inputs, initial_state, attention_states,
                                ...
                                dtype=dtypes.float32, scope=None,
                                initial_state_attention=False, beam_search=True,
                                beam_size=10):
